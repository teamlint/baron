...
import (
	...
	templateFileAssets "github.com/teamlint/baron/gengokit/template"
	"github.com/teamlint/baron/svcdef"

	"github.com/teamlint/baron/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/teamlint/baron",
		PBPackage: "github.com/teamlint/baron/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	const goPackage = "github.com/teamlint/baron/gengokit"
	const goPBPackage = "github.com/teamlint/baron/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/teamlint/baron/gengokit",
		PBPackage: "github.com/teamlint/baron/gengokit/general-service",
	}
