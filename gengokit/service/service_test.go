...
import (
	...
	helper "github.com/teamlint/baron/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/teamlint/baron/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/teamlint/baron/gengokit/general-service"
		)
