...
// Version: v0.2.6-dirty
// Version Date: 2020-12-03T19:05:19+08:00
...
func DecodeHTTPEchoZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	if JsonStrEchoStrArr, ok := queryParams["json_str"]; ok {
		...
		var JsonStrEcho *wrapperspb.StringValue
		JsonStrEcho = &wrapperspb.StringValue{}
		err = json.Unmarshal([]byte(JsonStrEchoStr), JsonStrEcho)
		if err != nil {
			return nil, errors.Wrapf(err, "couldn't decode JsonStrEcho from %v", JsonStrEchoStr)
		}
	...
	if JsonInt64EchoStrArr, ok := queryParams["json_int64"]; ok {
		...
		var JsonInt64Echo *wrapperspb.Int64Value
		JsonInt64Echo = &wrapperspb.Int64Value{}
	...
	if CreatedAtEchoStrArr, ok := queryParams["created_at"]; ok {
		...
		var CreatedAtEcho *timestamppb.Timestamp
		CreatedAtEcho = &timestamppb.Timestamp{}
	...
	if AnyDataEchoStrArr, ok := queryParams["any_data"]; ok {
		...
		var AnyDataEcho *anypb.Any
		AnyDataEcho = &anypb.Any{}
	...
	if StructDataEchoStrArr, ok := queryParams["struct_data"]; ok {
		...
		var StructDataEcho *structpb.Struct
		StructDataEcho = &structpb.Struct{}
	...
	if EmptyDataEchoStrArr, ok := queryParams["empty_data"]; ok {
		...
		var EmptyDataEcho *emptypb.Empty
		EmptyDataEcho = &emptypb.Empty{}
	...
	if DurationDataEchoStrArr, ok := queryParams["duration_data"]; ok {
		...
		var DurationDataEcho *durationpb.Duration
		DurationDataEcho = &durationpb.Duration{}
	...
	if MaskDataEchoStrArr, ok := queryParams["mask_data"]; ok {
		...
		var MaskDataEcho *fieldmaskpb.FieldMask
		MaskDataEcho = &fieldmaskpb.FieldMask{}
...
func EncodeHTTPEchoZeroRequest(_ context.Context, r *http.Request, request interface{}) error {
	...
	if err != nil {
		return errors.Wrap(err, "failed to marshal req.JsonStr")
	}
	strval = string(tmp)
