...
var file_echo_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x86, 0x02, 0x0a, 0x04,
...
var file_echo_proto_depIdxs = []int32{
	...
	3,  // 13: echo.Echo.Echo:output_type -> echo.EchoResponse
	3,  // 14: echo.Echo.Louder:output_type -> echo.EchoResponse
	3,  // 15: echo.Echo.LouderGet:output_type -> echo.EchoResponse
