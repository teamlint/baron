...
func NewEndpoints(svc pb.EchoServer) pb.Endpoints {
	// Business domain
	svc = service.WrapService(svc)
	// Endpoint domain
	var (
		echoEndpoint      = pb.MakeEchoEndpoint(svc)
		louderEndpoint    = pb.MakeLouderEndpoint(svc)
		loudergetEndpoint = pb.MakeLouderGetEndpoint(svc)
	)
	...
	// Wrap selected Endpoints with middlewares
