...
import (
	...
	handler "github.com/teamlint/baron/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	svc "github.com/teamlint/baron/cmd/_integration-tests/transport/transportpermutations-service/svc"
)
